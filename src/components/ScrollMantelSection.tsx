...
body{font-family:'Inter',sans-serif;color:#6B4423;overflow-x:hidden;-webkit-font-smoothing:antialiased}html{color-scheme:light}
...
.sticky-wrap::before{content:'';position:absolute;inset:0;opacity:.25;pointer-events:none;background-image:linear-gradient(90deg,rgba(107,68,35,.5) 1px,transparent 1px),linear-gradient(0deg,rgba(107,68,35,.5) 1px,transparent 1px);background-size:32px 32px}
...
.tc-p{position:absolute;inset:0;opacity:.2;pointer-events:none;background-image:linear-gradient(90deg,rgba(250,247,242,.4) 1px,transparent 1px),linear-gradient(0deg,rgba(250,247,242,.4) 1px,transparent 1px);background-size:32px 32px}
