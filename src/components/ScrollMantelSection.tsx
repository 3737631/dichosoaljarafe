...
export default function ScrollMantelSection() {
  ...
  const tableclothWaveY = useTransform(smoothProgress, (p) => Math.sin(p * Math.PI * 4.5) * 4);
  ...
  // Mobile cards
  const mItem1Opacity = useTransform(smoothProgress, [0.18, 0.28, 0.44, 0.52], [0, 1, 1, 0]);
  const mItem1Y = useTransform(smoothProgress, [0.18, 0.28, 0.44, 0.52], [20, 0, 0, -20]);

  const mItem2Opacity = useTransform(smoothProgress, [0.40, 0.50, 0.64, 0.72], [0, 1, 1, 0]);
  const mItem2Y = useTransform(smoothProgress, [0.40, 0.50, 0.64, 0.72], [20, 0, 0, -20]);

  const mItem3Opacity = useTransform(smoothProgress, [0.56, 0.66, 0.78, 0.86], [0, 1, 1, 0]);
  const mItem3Y = useTransform(smoothProgress, [0.56, 0.66, 0.78, 0.86], [20, 0, 0, -20]);

  const mItem4Opacity = useTransform(smoothProgress, [0.72, 0.84, 1.0], [0, 1, 1]);
